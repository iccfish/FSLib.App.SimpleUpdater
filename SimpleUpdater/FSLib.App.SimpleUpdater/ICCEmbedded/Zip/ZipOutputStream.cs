...
using ICCEmbedded.SharpZipLib.Checksums;
using ICCEmbedded.SharpZipLib.Zip.Compression;
using ICCEmbedded.SharpZipLib.Zip.Compression.Streams;

namespace ICCEmbedded.SharpZipLib.Zip
{
	/// <summary>
	...
	public class ZipOutputStream : DeflaterOutputStream
	{
		...
		/// </exception>
		/// <see cref="ICCEmbedded.SharpZipLib.Zip.Compression.Deflater"/>
